...
const About = () => {
  ...
  return (
    <div className='text-white  sm:mx-auto mx-10 max-x-2xl w-full sm:w-72'>
      <div className='text-white mt-24 flex flex-row sm:flex-col justify-evenly items-center'>
        ...
        <div className='sm:w-full w-1/3 sm:mx-auto'>
          <motion.p
            ref={ref}
            initial='hidden'
      ...
      <div className='mx-20 sm:-mx-2 sm:w-full w-1/2 my-20'>
        <h2 className='text-glacous  ml-8 sm:ml-0 text-lg font-semibold sm:py-0 py-4'>
          Experience
        </h2>{' '}
        <Tabs
      ...
      <div id='projects' className='mx-32 '>
      ...
      <div>
        ...
        <p className='px-3 pb-4 sm:w-full w-1/2 sm:-mx-2 mx-auto'>
        ...
        >
          <Card className='sm:py-4  rounded-md mx-3'>
            ...
            <CardHeader className='pb-0 pt-2 px-4 sm:px-0 flex-col'>
              <motion.p
                animate={winWidth > 768 ? { x: [-100, 0] } : { y: [100, 0] }}
                transition={{ ease: 'easeIn', duration: 1 }}
                initial={{ opacity: 0 }}
      ...
      <div className='flex sm:justify-between justify-center items-center border mx-4 sm:-mx-8 my-4 py-10 px-2 rounded-md'>
        <motion.div
